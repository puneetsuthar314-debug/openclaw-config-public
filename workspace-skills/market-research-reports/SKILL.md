...
description: "Generate comprehensive market research reports (50+ pages) in the style of top consulting firms (McKinsey, BCG, Gartner). Use when the user asks for industry analysis, market research, competitive landscape reports, or strategic analysis using frameworks like Porter Five Forces, PESTLE, SWOT, TAM/SAM/SOM, or BCG Matrix. NOT for quick searches or single-stock analysis."
