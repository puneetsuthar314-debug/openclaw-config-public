---
name: claw-release
description: "Release automation for Claw skills and website. Guides through version bumping, tagging, and release verification. Use when the user asks to publish, release, or version-bump a skill or the Claw website. Internal utility, not for general development tasks."
