...
description: "Perform comprehensive exploratory data analysis and create publication-ready visualizations for scientific data. This skill integrates data analysis across 200+ formats with advanced plotting capabilities for creating journal-quality figures. Use when the user needs scientific data analysis, statistical modeling, hypothesis testing, or publication-quality charts/figures. NOT for business data dashboards or stock analysis."
license: MIT license
metadata:
