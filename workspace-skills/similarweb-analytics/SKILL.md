...
description: "Analyze websites and domains using SimilarWeb traffic data. Get traffic metrics, engagement stats, global rankings, traffic sources, and geographic distribution for comprehensive website research. Use when the user asks about website traffic, domain analytics, competitor website comparison, or web traffic rankings. NOT for stock/financial analysis or general data analysis."
---
