---
name: soul-guardian
description: "Drift detection + baseline integrity guard for agent workspace files with automatic alerting support. Use when performing security audits on workspace files, checking if critical files (AGENTS.md, SOUL.md, TOOLS.md) have been tampered with, or when the user asks to verify workspace integrity or detect unauthorized changes."
