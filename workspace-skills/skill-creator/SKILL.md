---
name: skill-creator
description: "Guide for creating or updating skills that extend the agent via specialized knowledge, workflows, or tool integrations. Use when the user asks to create a new skill, modify an existing skill, or improve a skill definition. For any skill modification request, MUST first read this skill and follow its update workflow."
